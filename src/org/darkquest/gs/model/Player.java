...
public final class Player extends Mob {
  ...
  public void incExp(int i, int amount, boolean useFatigue, boolean combat, boolean useMultiplier) {
    ...
    if(i < 7) {
      if(i < 3) {
        this.getCache().update("xppoints", this.getCache().getLong("xppoints") + (long)(amount * exprate));
        this.getActionSender().sendCacheableLong("xppoints", this.getCache().getLong("xppoints"));
      }
      if(i > 3) {
        this.getCache().update("xppoints", this.getCache().getLong("xppoints") + ((long)(amount * exprate)) * 3);
        this.getActionSender().sendCacheableLong("xppoints", this.getCache().getLong("xppoints"));
      }
    } else {
